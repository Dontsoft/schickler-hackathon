...
class RequestItem(BaseModel):
    ...
    pad_pleasure: Union[float, None] = 0.0
    pad_arousal: Union[float, None] = 0.0
    pad_dominance: Union[float, None] = 0.0
    preview_pad_pleasure: Union[float, None] = 0.0
    preview_pad_arousal: Union[float, None] = 0.0
    preview_pad_dominance: Union[float, None] = 0.0
    emo_aerger: Union[float, None] = 0.0
    emo_erwarten: Union[float, None] = 0.0
    emo_ekel: Union[float, None] = 0.0
    emo_furcht: Union[float, None] = 0.0
    emo_freude: Union[float, None] = 0.0
    emo_traurigkeit: Union[float, None] = 0.0
    emo_ueberraschung: Union[float, None] = 0.0
    emo_vertrauen: Union[float, None] = 0.0
    preview_emo_aerger: Union[float, None] = 0.0
    preview_emo_erwarten: Union[float, None] = 0.0
    preview_emo_ekel: Union[float, None] = 0.0
    preview_emo_furcht: Union[float, None] = 0.0
    preview_emo_freude: Union[float, None] = 0.0
    preview_emo_traurigkeit: Union[float, None] = 0.0
    preview_emo_ueberraschung: Union[float, None] = 0.0
    preview_emo_vertrauen: Union[float, None] = 0.0
    article_header_contains_quote: Union[int, None] = 0.0
    article_header_contains_question: Union[int, None] = 0.0
    article_header_contains_doppelpunkt: Union[int, None] = 0.0
    article_header_contains_pronoun_writer: Union[int, None] = 0.0
    article_header_contains_pronoun_reader: Union[int, None] = 0.0
    article_preview_contains_quote: Union[int, None] = 0.0
    article_preview_contains_question: Union[int, None] = 0.0
    article_preview_contains_doppelpunkt: Union[int, None] = 0.0
    article_preview_contains_pronoun_writer: Union[int, None] = 0.0
    article_preview_contains_pronoun_reader: Union[int, None] = 0.0
    topic: str
    locality : str
    newstype :str
    genre: str
