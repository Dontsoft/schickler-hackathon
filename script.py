...
ARTICLE_DATA_PATH = lambda x: f"C:/hackathon/Techlabs Hackathon/Drive Daten/students_articles_enriched_{x}.parquet.gzip"
PAGEVIEW_DATA_PATH = "C:/hackathon/Techlabs Hackathon/Drive Daten/students_pageviews_2021-01-02.parquet.gzip"
gc.collect()
...
pageview_data = pd.concat([get_first_batch(f) for f in glob.glob("C:/hackathon/Techlabs Hackathon/Drive Daten/students_pageviews*.gzip")])
